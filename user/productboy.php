...
$query = "SELECT * FROM sanpham WHERE type = 'quannam' OR type = 'aonam' LIMIT $limit OFFSET $offset";
$result = mysqli_query($conn, $query);

// Tính tổng số sản phẩm theo loại
$total_query = "SELECT COUNT(*) AS total FROM sanpham WHERE type = 'quannam' OR type = 'aonam'";
